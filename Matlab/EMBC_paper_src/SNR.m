...
% fi3=figure();
% plot (total_y,  sta_out(:,1),'r','linewidth',3);hold on;
% plot (total_y,  sta_out(:,2),'b','linewidth',3);hold on;
% 
% set(gca,'linewidth',3,'fontsize',30,'fontname','Times');
% legend('SNR<10 dB','SNR>=10 dB');

fi4=figure();
plot (total_y,  sta_out(:,3)*100,'k','linewidth',3);hold on;
xlabel('Vessels Y-axis (nm)');
ylabel('Percentages');
set(gca,'linewidth',3,'fontsize',25,'fontname','Times');
title('Distribution (SNR>10 dB)');
