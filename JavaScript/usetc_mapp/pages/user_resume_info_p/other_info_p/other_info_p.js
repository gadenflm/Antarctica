...
Page({
    ...
    getData: function() {
        let temp = [..._app.data.user_resume_info.other_info];
    ...
    add_information: function() {
        ...
        tt.navigateTo({
            url: './other_info_input/other_info_input'
        })
    },
    /**
     * @description 设置显示的参数
    ...
    updata_info: function() {
        ...
        _app.data.user_resume_info.other_info = [...temp];
