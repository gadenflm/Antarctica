...
Page({
    ...
    getData: function() {
        let temp = [..._app.data.user_resume_info.award_info];
    ...
    add_information: function() {
        ...
        tt.navigateTo({
            url: './award_info_input/award_info_input'
        })
    },
    /**
     * @description 设置显示的参数
    ...
    updata_info: function() {
        ...
        _app.data.user_resume_info.award_info = [...temp];
